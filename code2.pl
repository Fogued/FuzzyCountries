...
(population_density, rfuzzy_float_type), % Por cada km^2
(agricultural_land, rfuzzy_float_type),
(land_area, rfuzzy_float_type), % En km^2
(armed_forces_size, rfuzzy_float_type),
(birth, rfuzzy_float_type),
(co2_emissions, rfuzzy_float_type),
(cpi, rfuzzy_float_type), % Consumer price index
(fertility, rfuzzy_float_type),
(forested_area, rfuzzy_float_type),
(gdp, rfuzzy_float_type), % Gross domestic product (PIB)
...
(population, rfuzzy_float_type),
(labor_force, rfuzzy_float_type), % Poblacion activa
(tax_revenue, rfuzzy_float_type),
(unemployment, rfuzzy_float_type),
(urban_population, rfuzzy_float_type),
(latitude, rfuzzy_float_type),
(longitude, rfuzzy_float_type),
(renewables, rfuzzy_float_type),
(minimum_wage, rfuzzy_float_type),
(median_age, rfuzzy_float_type)]).
...
country(33, New_Zealand, 8.43, 11.18, 13.171566666666664, 0.242, 18.0, 40.50, 268838.0, 9000.0, 11.98, 34382.0, 114.24, 1.71, 38.60, 206928765544.0, 100.00, 82.00, 4.7, 81.9, 4841000.0, 69.90, 29.00, 4.07, 4258860.0, -40.900557, 174.885971, 40.21865, 27881.0, 38.0).
...
country(42, South_Africa, 6.53, 18.06, 23.712533333333337, 0.86, 49.0, 79.80, 1219090.0, 80000.0, 20.51, 476644.0, 158.93, 2.41, 7.60, 351431649241.0, 100.90, 22.40, 28.5, 63.9, 58558270.0, 56.00, 27.50, 28.18, 39149717.0, -30.559482, 22.937506, 3.408608, 3511.0, 28.0).
...
country(44, Sri_Lanka, 6.13, 27.4, 18.3899, 0.863, 341.0, 43.70, 65610.0, 317000.0, 15.83, 23362.0, 155.53, 2.2, 32.90, 84008783756.0, 100.20, 19.60, 6.4, 76.8, 21803000.0, 53.90, 11.90, 4.20, 4052088.0, 7.873054, 80.771797, 21.404533, 787.0, 34.0).
